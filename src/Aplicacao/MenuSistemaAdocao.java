	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				sistema.addAnimal(tipo,nome,idade,sexo,raca,cor,castrado,vacinado);
				break;
			...
			case 4: // Submenu - Listagens
				do{
					...
					case 5:
						// Listar por gênero
						String especie = TratamentoEntrada.lerString(scan, "Digite a espécie de animal que deseja consultar: ");
						System.out.print("Digite o gênero que deseja consultar (M/F): ");
						char gen = scan.next().toUpperCase().charAt(0);
			...
			case 5: // Submenu - Estatísticas
				do {
					...
					opcao1 = scan.nextInt(); // Cuidado: após nextInt()/next(), adicione um nextLine() para consumir a quebra de linha
